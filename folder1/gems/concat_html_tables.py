...
class concat_html_tables(MacroSpec):
    name: str = "concat_html_tables"
    projectName: str = "test_sql_orch"
    category: str = "Custom"


    @dataclass(frozen=True)
    class concat_html_tablesProperties(MacroProperties):
    ...
    def apply(self, props: concat_html_tablesProperties) -> str:
    ...
    def loadProperties(self, properties: MacroProperties) -> PropertiesType:
        ...
        return concat_html_tables.concat_html_tablesProperties(
